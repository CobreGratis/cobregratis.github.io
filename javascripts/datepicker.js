$(document).ready(function () {
  $('input.addDatepicker').datepicker({
    ...
    showOn:'focus', // Have the datepicker appear automatically when the field receives focus ('focus'), appear only when a button is clicked ('button'), or appear when either event takes place ('both').
